...
<html lang="pt-BR">
    <head>
        ...
        <link rel="stylesheet" href="http://<?=URL?>/public/css/footer-style.css">
        <link rel="stylesheet" href="http://<?=URL?>/public/css/restaurante-cadastro-style.css">
        ...
        <script src="http://<?=URL?>/public/js/mask.js"></script>
    </head>
    <style>
        .container-fluid{background:url('http://<?=URL?>/public/img/bg/bg-cadastro.jpg')no-repeat center;-webkit-background-size:cover;-moz-background-size:cover;-o-background-size:cover;background-size:cover}
    </style>
    <body>
        ...
        <div id="container" class="container mb-4">
            <div class="card mx-5">
                <div class="card-body">
                    <form id="form-cadastro" action="http://<?=URL?>/app/Controllers/RegisterController.php" method="post">
