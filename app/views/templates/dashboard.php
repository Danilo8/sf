...
<nav class="navbar navbar-dark bg-dark">
    <span class="navbar-brand mb-0 h1 mr-0">
        <img height="55" src="http://localhost/sf/public/img/logo/logo.png" alt="">
    ...
    <ul class="nav justify-content-center">
        <li class="nav-item">
            <?php if($route->File == "dashboard") { ?>
                <a class="nav-link active" href="http://localhost/sf/restaurante/dashboard">DASHBOARD</a>           
            <?php } else { ?>
        ...
        <li class="nav-item">
            <?php if($route->File == "pedidos") { ?>
                <a class="nav-link active" href="http://localhost/sf/restaurante/pedidos">PEDIDOS</a>
            <?php } else { ?>
        ...
        <li class="nav-item">
            <?php if($route->File == "cardapio") { ?>
                <a class="nav-link active" href="http://localhost/sf/restaurante/cardapio">CARDÁPIO</a>         
            <?php } else { ?>
        ...
        <li class="nav-item">
            <?php if($route->File == "administrador") { ?>
                <a class="nav-link active" href="http://localhost/sf/restaurante/administrador">ADMINISTRADOR</a>           
            <?php } else { ?>
        ...
        <li class="nav-item">
            <?php if($route->File == "relatorios") { ?>
                <a class="nav-link active" href="http://localhost/sf/restaurante/relatorios">RELATÓRIOS</a>           
            <?php } else { ?>
